...
class ArticlesControllerTest < ActionDispatch::IntegrationTest
  ...
  def test_should_create_valid_article
    ...
    assert_response :success
    response_json = response_body
    assert_equal "Created new article", response_json["notice"]
  end
  ...
  def test_shouldnt_create_article_without_title
    ...
    response_json = response_body
    assert_equal "Title can't be blank and Title is invalid", response_json["error"]
  end
  ...
  def test_articles_filds_are_updatable
