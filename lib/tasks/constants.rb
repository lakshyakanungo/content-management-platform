...

{
  ...
  author: "Oliver",
  body: "<p></p><ul><li><p>CSS Grid Layout is a powerful tool for creating complex web layouts.</p></li><li><p>It allows you to define grid <u>containers</u> and grid <u>items</u>.</p></li><li><p>You can create responsive designs with ease using CSS Grid.</p></li><li><p>It's excellent for creating multi-column layouts, grids of images, and more.</p></li><li><p>Mastering CSS Grid is a key skill for front-end web developers.</p></li></ul>",
  status: "draft",
  last_published_at: nil,
...
},
{
  ...
  author: "Oliver",
  body: "<p>Important times require peaceful thought process.</p>",
  status: "published",
...
},
{
  ...
  author: "Oliver",
  body: "<ol><li><p><code>Error handling is a crucial aspect of programming. This article covers exception handling in Ruby, explaining how to use begin and rescue blocks to handle errors gracefully.</code></p></li></ol><p><br></p>",
  status: "draft",
  last_published_at: nil,
  category_id: "e7688066-117f-4439-bab1-b5434d0836cd"
},
{
  ...
  author: "Oliver",
  body: "<p></p><ol><li><p>This article delves into object-oriented programming (OOP) in Ruby. It explains how to define classes, create objects, and implement inheritance and polymorphism in Ruby.</p></li><li><p></p></li></ol><p><br></p>",
  status: "published",
...
},
{
  title: "Sweet.",
  author: "Oliver",
  body: "<p><span style=\"color: rgb(104, 115, 125)\">Add description here.</span></p><p></p><p><span style=\"color: rgb(104, 115, 125)\">Its so sweet</span></p>",
  status: "published",
...
},
{
  ...
  author: "Oliver",
  body: "<p></p><p>This article discusses techniques for optimizing web performance to reduce loading times. It covers topics such as </p><ul><li><p>image optimization,</p></li><li><p><em><span style=\"color: #a31b1b\"><u> lazy loading</u></span></em}, </p></li><li><p>and code splitting.</p></li></ul>",
  status: "published",
...
},
{
  ...
  author: "Oliver",
  body: "<p></p><p></p><ul><li><p>This article provides an introduction to responsive web design principles. It covers media queries, flexible layouts, and fluid images for creating web pages that adapt to various screen sizes.</p><p><span data-type=\"mention\" data-id=\"eve-smith\" data-label=\"Eve Smith\">@Eve Smith</span> </p></li></ul>",
  status: "draft",
  last_published_at: nil,
  category_id: "6ceed3d8-014a-443f-af6d-5ffa171ccf12"
},
{
  ...
  author: "Oliver",
  body: "<p></p><p>This article delves into the modern JavaScript ecosystem, including ES6 features, package management with npm, and the use of popular libraries and frameworks like React and Vue.</p><p><br></p>",
  status: "draft",
  last_published_at: nil,
  category_id: "6ceed3d8-014a-443f-af6d-5ffa171ccf12"
},
...
},
{
  ...
  author: "Oliver",
  body: "<p></p><p>This article serves as an introduction to Ruby for beginners. It covers the basics of Ruby syntax, data types, variables, and how to write simple programs in Ruby.</p><pre><code class=\"language-ruby\"># Hello, World! in Ruby\nputs \"Hello, World!\"\n</code></pre>",
  status: "published",
